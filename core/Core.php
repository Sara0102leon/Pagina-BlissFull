...
class Core {
	...
	public static function alert($txt){
		echo "<script>if(typeof Swal!=='undefined'){Swal.fire({icon:'info',title:'Aviso',text:'".$txt."',confirmButtonColor:'#b87e38'});}else{alert('".$txt."');}</script>";
	}
